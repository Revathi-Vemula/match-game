...
class MatchGame extends Component {
  ...
  getRandomImageUrl = () => {
    let randomImageUrl = ''
    const indexOfRandomObject = Math.ceil(Math.random() * imagesList.length - 1)
    randomImageUrl = imagesList[indexOfRandomObject].imageUrl
